...
**JupyterLab** is a web-based interface (IDE) that allows you to use Jupyter Notebooks to write, run, and debug Python code. JupyterLab is an online environment that allows you to run your code in the cloud.

**Jupyter Notebook** can be used and run in the web-based interface through JupyterLab
...
**Methods** are functions that are associated with objects/classes. They are called using dot notation, where the method name is preceded by the object name and a dot. For example, in the expression `my_list.append(5)`, `append` is a method of the `my_list` object.
...
**separator.join(words)** - returns a string with the words separated by the separator
...
`sort()` - sorts the items of a list in place (modifies the original list), reverse order if specified with `reverse=True`, `key` parameter can be used to specify a function to be called on each list element prior to making comparisons
...
`insert()` - adds an item to a list at a specified index
...
`.isnumeric()` - checks if a string contains only numeric characters (boolean)

`.isalpha()` - checks if a string contains only alphabetic characters (boolean)
...
for x in range(0,101,10):
  print("{:>3} F | {:>6.2f} C".format(x, to_celsius(x))) # formatted with alignment and precision

  #farenheit has a width of 3, right aligned
  #celsius has a width of 6, 2 decimal places, right aligned
```

Formatting expressions:

format is {: <fill> <align> <width> . <precision> <type>}

| Format Type     | Format Specifier | Description |
| --------------- | --- | ----------------------------------------------------------------------------------------------------------------------------- |
| :.2f            | type | Formats a floating-point number to 2 decimal places                                                                           |
| :{fill char}>10 | align | Right aligns the result within a field of 10 characters, set spaces of 10 characters if the result is less than 10 characters |
| :<10            | align | Left aligns the result within a field of 10 characters, purely for alignment or padding                                       |
| :^10            | align | Center aligns the result within a field of 10 characters                                                                      |
| :10.2f          | type | Formats a floating-point number to 2 decimal places within a field of 10 characters                                           |
| :=              | align | Places the sign to the left most position                                                                                     |
...
| :%              | Use a percentage sign as a suffix                                                                                             |
| :               | Use a space as a padding character                                                                                            |
| :d              | Decimal format                                                                                                                |
...
| :05d            | Formats an integer with leading zeros to fill a width of 5 characters                                                         |
| :b              | Binary format                                                                                                                 |
